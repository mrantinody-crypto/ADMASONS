    ...
    <section id="contact" className="py-28 bg-gradient-to-b from-card/50 via-card/50 to-background relative overflow-hidden">
      ...
      <div ref={sectionRef} className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className={`grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "200ms" }}>
          {/* Contact form */}
          <div className="bg-blue-50/50 backdrop-blur-sm border border-blue-200/[0.06] rounded-2xl p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/50 border border-blue-200/[0.08] rounded-xl text-foreground placeholder:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-white/50 border border-blue-200/[0.08] rounded-xl text-foreground placeholder:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all resize-none"
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-900 to-blue-800 text-white hover:from-blue-500 hover:to-blue-500 font-semibold py-4 text-lg rounded-xl flex items-center justify-center shadow-lg shadow-blue-200/40 hover:shadow-blue-300/50 transition-all duration-300 hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0 group"
              >
          ...
          <div className="space-y-6">
            <div className="bg-blue-50/50 backdrop-blur-sm border border-blue-200/[0.06] rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:theadmasons@gmail.com" className="text-blue-900 hover:text-blue-300 transition-colors font-medium">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-800 text-sm">Get a free consultation - quick response</p>
              </div>
            ...
            {/* Map embed */}
            <div className="bg-blue-50/50 border border-blue-200/[0.06] rounded-2xl overflow-hidden">
              <iframe
