...
const testimonials = [
  {
    name: "Rahul Sharma",
    role: "CEO, LuxeCart",
    content: "We were burning money on ads with zero clarity. Ad Masons restructured our entire funnel and within 60 days our ROAS went from 1.2x to 4.5x. They don\u0027t just run ads - they build systems.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Our product launch needed to make noise fast on a tight budget. Ad Masons got us 50K+ reach in the first week through influencer seeding and smart Meta ads. The brand finally felt real.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Before Ad Masons, 70% of our leads were junk. They set up lead scoring, WhatsApp automation, and hyper-local targeting. Now our sales team closes more in a week than they used to in a month.",
    rating: 5,
  ...
  },
  {
    ...
    content: "We opened a new restaurant with zero online presence. Ad Masons handled everything - Google listings, food photography, local ads. Our footfall tripled in 45 days. Worth every rupee.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Our Instagram was dead at 2K followers. Ad Masons built a reels strategy, ran lead-gen ads, and in 3 months we hit 25K followers with actual inquiries. Not vanity metrics - real business.",
    rating: 5,
